...
//components
import { CommentIcon } from "@/components/home-page/posts/CommentIcon";
...
export const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  return (
    <div className="relative flex flex-col items-end bg-background md:h-auto w-[250px] lg:w-[300px] xl:w-[350px] rounded-br-md">
      ...
      <div className="min-h-32 w-full flex flex-col justify-between gap-3 p-3">
        ...
        <div className="flex gap-2 items-center justify-between gap-2">
          ...
          <span className="text-sm">{text.length}/250</span>
